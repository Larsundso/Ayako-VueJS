    ...
    const features = [
      {
        ...
        url: 'moderation',
        image: 'https://cdn.ayakobot.com/website_assets/moderation.png',
      },
      {
        ...
        url: 'server',
        image: 'https://cdn.ayakobot.com/website_assets/rp.png',
      },
      {
        name: 'Role Management',
        desc: 'Button Roles, Category Roles, Auto-Roles, Sticky Roles, Booster Roles, Self-Roles, etc',
        url: 'roles',
        image: 'https://cdn.ayakobot.com/website_assets/roles.png',
      },
